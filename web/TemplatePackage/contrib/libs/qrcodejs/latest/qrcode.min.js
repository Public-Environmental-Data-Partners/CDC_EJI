var QRCode = function(t) {
    ...
    var w = o,
        ...
        E = h((function(t, r) {
            ...
            r.isValid = function(t) {
                ...
                for (var r = t.size, e = 0, n = 0, o = 0, a = null, i = null, u = 0; u < r; u++) {
                    n = o = 0, a = i = null;
                    for (var s = 0; s < r; s++) {
                        var f = t.get(u, s);
                        f === a ? n++ : (n >= 5 && (e += n - 5 + 3), a = f, n = 1), (f = t.get(s, u)) === i ? o++ : (o >= 5 && (e += o - 5 + 3), i = f, o = 1)
                    }
                    n >= 5 && (e += n - 5 + 3), o >= 5 && (e += o - 5 + 3)
                }
                return e
                ...
                for (var r = t.size, e = 0, n = 0, o = 0, a = 0; a < r; a++) {
                    n = o = 0;
                    for (var i = 0; i < r; i++) n = n << 1 & 2047 | t.get(a, i), i >= 10 && (1488 === n || 93 === n) && e++, o = o << 1 & 2047 | t.get(i, a), i >= 10 && (1488 === o || 93 === o) && e++
                }
                return 40 * e
            }, r.getPenaltyN4 = function(t) {
                for (var r = 0, e = t.data.length, n = 0; n < e; n++) r += t.data[n];
                return 10 * Math.abs(Math.ceil(100 * r / e / 5) - 10)
            }, r.applyMask = function(t, r) {
                for (var n = r.size, o = 0; o < n; o++)
                    for (var a = 0; a < n; a++) r.isReserved(a, o) || r.xor(a, o, e(t, a, o))
    ...
    function at(t, r, e) {
        ...
        return function(t, r, e) {
            for (var n = a(r), o = n - M(r, e), i = I(r, e), u = i - n % i, s = Math.floor(n / i), f = Math.floor(o / i), h = f + 1, c = s - f, g = new L(c), d = 0, l = new Array(i), v = new Array(i), p = 0, w = new Uint8Array(t.buffer), m = 0; m < i; m++) {
                var E = m < u ? f : h;
                l[m] = w.slice(d, d + E), v[m] = g.encode(l[m]), d += E, p = Math.max(p, E)
            }
            var y, A, N = new Uint8Array(n),
                B = 0;
            for (y = 0; y < p; y++)
                for (A = 0; A < i; A++) y < l[A].length && (N[B++] = l[A][y]);
            for (y = 0; y < c; y++)
                for (A = 0; A < i; A++) N[B++] = v[A][y];
            return N
        }(n, t, r)
    }
            ...
            r.getOptions = function(t) {
                ...
                for (var o = e.modules.size, a = e.modules.data, i = r.getScale(o, n), u = Math.floor((o + 2 * n.margin) * i), s = n.margin * i, f = [n.color.light, n.color.dark], h = 0; h < u; h++)
                    for (var c = 0; c < u; c++) {
                        var g = 4 * (h * u + c),
                            d = n.color.light;
                        h >= s && c >= s && h < u - s && c < u - s && (d = f[a[Math.floor((h - s) / i) * o + Math.floor((c - s) / i)] ? 1 : 0]), t[g++] = d.r, t[g++] = d.g, t[g++] = d.b, t[g] = d.a
                    }
            }
        }));
    ...
    var dt = ut,
        lt = gt.bind(null, ft.render),
        vt = gt.bind(null, ft.renderToDataURL),
        pt = gt.bind(null, (function(t, r, e) {
            return function(t, r, e) {
    ...
    return t.create = dt, t.default = wt, t.toCanvas = lt, t.toDataURL = vt, t.toString = pt, Object.defineProperty(t, "__esModule", {
        value: !0
    }), t
}({});